...
from src.app.utils.auth import get_accessible_marches, user_can_view_march
...
def _create_admin_participants_table(participants_df):
    ...
    from src.app.components.march.march_overview import create_participants_table
...
def _create_leaderboard_table(leaderboard_df):
    ...
    from src.app.components.march.march_overview import create_leaderboard_table
